 ...
 * * `TTCMA()->is_primary_nav_menu_active()`
 * * `TTCMA()->display_primary_nav_menu( array $args = array() )`
 */
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function hooks() {
		...
		add_filter( 'TTCMA_menu_toggle_button', array( $this, 'customize_mobile_menu_toggle' ) );
		add_filter( 'TTCMA_site_navigation_classes', array( $this, 'customize_mobile_menu_nav_classes' ) );
	}
	...
	private function get_theme_settings_config() {
		...
		$this->theme_settings = apply_filters( 'TTCMA_customizer_settings', json_decode( $theme_settings_json, FILE_USE_INCLUDE_PATH ) );
	}
	...
	public function action_register_nav_menus() {
		register_nav_menus(
			array(
				static::PRIMARY_NAV_MENU_SLUG => esc_html__( 'Primary', 'TTCMA' ),
			)
		);
	}
	...
	public function customize_mobile_menu_toggle() {
		return '<button class="menu-toggle icon" aria-label="' . esc_html__( 'Open menu', 'TTCMA' ) . '" aria-controls="primary-menu" aria-expanded="false">
	...
	public function customize_mobile_menu_nav_classes() {
		return esc_html__( 'main-navigation nav--toggle-sub nav--toggle-small icon-nav', 'TTCMA' );
	}
}
