 ...
 * * `TTCMA()->the_comments( array $args = array() )`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function the_comments( array $args = array() ) {
		...
		$amp_live_list = TTCMA()->using_amp_live_list_comments();
		...
		if ( $amp_live_list ) {
			...
			?>
				<div update>
					<button class="button" on="tap:amp-live-comments-list-<?php the_ID(); ?>.update"><?php esc_html_e( 'New comment(s)', 'TTCMA' ); ?></button>
				</div>
			</amp-live-list>
			<?php
		}
